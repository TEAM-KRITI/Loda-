...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("IstkharMusic/assets/thumb/font2.ttf", 30)
        meta_font = ImageFont.truetype("IstkharMusic/assets/thumb/font.ttf", 22)
        ...
        if is_live:
            live_font = ImageFont.truetype("IstkharMusic/assets/thumb/font2.ttf", 22)
